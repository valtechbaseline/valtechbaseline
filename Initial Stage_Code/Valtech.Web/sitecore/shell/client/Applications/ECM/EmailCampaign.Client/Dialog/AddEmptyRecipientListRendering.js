...
define([
  "sitecore",
  "/-/speak/v1/listmanager/SelectFolder.js",
  ...
  return sitecore.Definitions.App.extend({
    initialized: function () {
      ...
      contextApp.insertRendering("{64D170BF-507C-4D53-BB4F-8FC76F5F2BBC}", { $el: $("body") }, function (subApp) {
        ...
        subApp.on('select:folder:dialog:button:cancel:clicked', function() {
          self.showDialog(showDialogParams);
        });
      ...
      sitecore.on("recipients:add:empty:list:dialog:show", contextApp.showDialog, contextApp);
    ...
    showDialog: function (params) {
      ...
      self.addListCallback = params.ok;
      self.addListMessageId = params.messageId;
      self.addListRecipientListType = params.recipientListType;
