define([
  ...
  return {
    initializePrimaryNavigation: function(app) {
      ...
      var createMessageContext = { createMessageOptions: contextApp.CreateMessageDialogDataSource };
      
      contextApp.on({
        'create:onetimemessage': function () {
          self.clickCreateButton();
          DialogService.show("createOneTimeMessage", createMessageContext);
        },
        'create:subscriptionmessage': function () {
          self.clickCreateButton();
          DialogService.show("createSubscriptionMessage", createMessageContext);
        },
        'create:triggeredmessage': function () {
          self.clickCreateButton();
          DialogService.show("createTriggeredMessage", createMessageContext);
        },
        ...
        'create:listfromexistinglist': function () {
          self.clickCreateButton();
          DialogService.show("addFromExistingList");
        }
      });
