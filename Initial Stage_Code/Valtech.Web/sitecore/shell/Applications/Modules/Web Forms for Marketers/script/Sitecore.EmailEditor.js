...
window.Sitecore.Wfm.EmailEditor = new function () {
  ...
  function load() {
    ...
    /*Obsolete*/
    window.Sitecore.EmailEditor.__RAD = rad;
    window.Sitecore.EmailEditor.__Field = $("__Field");
  ...
  window.Sitecore.EmailEditor = {
    ...
    GetIDByMediaPrefix: getIdByMediaPrefix,
    GetMediaID: getMediaId,
    insertSitecoreLink: insertSitecoreLink,
    createFieldMenu: createFieldMenu,
    createFieldMenuExt: createFieldMenu,
