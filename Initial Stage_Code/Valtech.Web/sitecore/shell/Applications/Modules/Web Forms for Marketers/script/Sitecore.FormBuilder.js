(function($j, scForm) {
  Sitecore.FormBuilder = new function() {
    ...
    /* Obsolete */
    this._tryToWindowOnLoadedInIE = tryToWindowOnLoadedInIe;

    /* Obsolete */
    this._scrollToElement = scrollToElement;

    /* Obsolete */
    this._selectPredefined = selectPredefined;

    /* Obsolete */
    this._isAllSectionsDeleted = isAllSectionsDeleted;

    /* Obsolete */
    this._selectVisibleElement = selectVisibleElement;

    /* Obsolete */
    this._setButtonState = setButtonState;

    /* Obsolete */
    this._getElementPositionByID = getElementPositionById;

    /* Obsolete */
    this._getElementByPosition = getElementByPosition;

    /* Obsolete */
    this.updateSize = function() {};

    /* Obsolete */
    this.onChangeSorting = function() {};
