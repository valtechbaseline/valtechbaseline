...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="showAutoOverview">
    <table cellspacing="0" cellpadding="0" border="0" width="100%" style="font-family: {$fontFamily}; font-size: {$fontSize};">
      ...
      <tr>
        <td colspan="5" height="10"><div style="height: 10px; font-size: 1px;">&#32;</div></td>
      </tr>
      <tr valign="top">
        ...
        <td>
          ...
          <table cellspacing="0" cellpadding="0" border="0" width="100%" style="font-family: {$fontFamily}; font-size: {$fontSize};">
            ...
            <xsl:for-each select="../item[@tid!=$autoOverviewTid]">
              <xsl:choose>
      ...
      <tr>
        <td colspan="5" height="18"><div style="height: 18px; font-size: 1px;">&#32;</div></td>
      </tr>
    </table>
  </xsl:template>
  ...
  <xsl:template name="showTopicLink">
    <tr valign="top">
      ...
      <td width="372">
        <a style="{$linkStyle} text-decoration: underline;" href="#{sc:Replace(@key,' ','')}" target="_self">
