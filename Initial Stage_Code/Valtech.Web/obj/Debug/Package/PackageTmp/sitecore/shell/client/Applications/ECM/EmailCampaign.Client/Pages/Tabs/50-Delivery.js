    ...
    attachEventHandlers: function () {
      sitecore.on({
        ...
        "dispatch:selectvariant": function (variantid) {
          ...
          DialogService.show('messageManualWinnerSelectConfirmation', {
            ok: _.bind(function () { this.dispatchAction("selectwinner", actionDetails); }, this),
      ...
      this.on({
        "dispatch:send": function() {
          this.SendButton.set("isEnabled", false);
      ...
      this.DispatchContext.on({
        "change:multiLanguageEnabled": this.setIsEnableNotificationEmail,
