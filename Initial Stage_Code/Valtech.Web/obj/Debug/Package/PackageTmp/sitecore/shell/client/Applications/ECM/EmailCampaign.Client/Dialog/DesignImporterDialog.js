define(["sitecore", "/-/speak/v1/ecm/MessageHelper.js", "/-/speak/v1/ecm/ServerRequest.js"], function (sitecore, MessageHelper) {
  return sitecore.Definitions.App.extend({
    ...
    hideDialog: function () {
      ...
      var result = MessageHelper.createNewTemplatesFromImportedDesign(context, contextApp.MessageBar, contextApp, sitecore);
      if (result) {
