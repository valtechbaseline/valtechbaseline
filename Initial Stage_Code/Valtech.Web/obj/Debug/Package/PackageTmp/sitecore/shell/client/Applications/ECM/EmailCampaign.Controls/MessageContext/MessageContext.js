...
], function ($, sitecore, ServerRequest, MessageHelper) {
  "use strict";
  ...
  var model = sitecore.Definitions.Models.ComponentModel.extend(
    {
      initialize: function () {
        ...
        this.set("sendingState", MessageHelper.SendingStates.UNDEFINED);
        this.set("messageState", MessageHelper.MessageStates.DRAFT);
      ...
      initStateWatcher: function (messageContext) {
        ...
        function stateRefreshPostback() {
          ...
          ServerRequest("EXM/CurrentState", {
            data: requestData,
            success: function (response) {
