(function() {
  ...
  /* Obsolete */
  window.Sitecore.ListEditor = Sitecore.Wfm.ListEditor;
  window.tableLength = null;
  window.scForm.OnChangeField = Sitecore.Wfm.ListEditor.onChangeField;
  window.OnAddNewItem = Sitecore.Wfm.ListEditor.onAddNewItem;
  window.OnRemoveItem = Sitecore.Wfm.ListEditor.onRemoveItem;
  window.getPosition = getPosition;
  window.OnListItemFocus = Sitecore.Wfm.ListEditor.onListItemFocus;
  window.OnListItemBlur = Sitecore.Wfm.ListEditor.onListItemBlur;
  window.showText = Sitecore.Wfm.ListEditor.showText;
  window.hideText = Sitecore.Wfm.ListEditor.hideText;
  window.showTextColumn = showTextColumn;
  window.hideTextColumn = hideTextColumn;
  window.ListItems_OnUpdate = Sitecore.Wfm.ListEditor.listItemsOnUpdate;
  window.controlValuesLock = Sitecore.Wfm.ListEditor.controlValuesLock;
})();